...
/**
 * Класс ASpriteManager предоставляет методы для управления размерами и ориентацией спрайтов и форм SFML.
 */
...
public:
    ...
    /**
     * Устанавливает относительную точку происхождения спрайта.
    ...
    /**
     * Устанавливает относительную точку происхождения формы.
